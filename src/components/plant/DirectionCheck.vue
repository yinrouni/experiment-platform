<template>
  <div>
    <el-row>
      <el-col :span="16">
        <video id="video" src="../../assets/检查方向.mp4" />
        <br>
        <ul class="type">
...
export default {
  ...
  methods: {
    ...
    isCorrect: function (rotationSpeed, flowSpeed, torque, holeMakers, plant, fix, handler) {
      ...
      !holeMakersGood ? this.tips.push('方向杆：先锋钻备洞后应使用方向指示器，检查窝洞的方向及深度。') : score += 4
      ...
      this.showCorrectDialog = holeMakersGood
      return holeMakersGood
